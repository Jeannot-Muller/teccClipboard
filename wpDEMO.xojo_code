...
#tag Events pbBlog
	...
	#tag EndEvent
#tag EndEvents
#tag Events pbCalculate
	#tag Event
		Sub Pressed()
		  Var result As Integer = tf1.Text.ToInteger + tf2.Text.ToInteger
		  
		  tf3.Text = result.ToString
		  
		  teccClipboard1.value = result.ToString
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events teccClipboard1
	...
	#tag EndEvent
#tag EndEvents
#tag Events pbCalculate1
	#tag Event
		Sub Pressed()
		  Var result As Integer = tf4.Text.ToInteger + tf5.Text.ToInteger
		  
		  tf6.Text = result.ToString
		  
		  teccClipboard2.value = result.ToString
		End Sub
	#tag EndEvent
#tag EndEvents
